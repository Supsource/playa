...
const VenueInfoScreen = () => {
  ...
  try {
    ...
    console.error("Error logging route parameters:", error);
  }
        ...
        <ScrollView>
          <>
                ...
                <View style={{ flexDirection: "row" }}>
                  {[0, 0, 0, 0, 0].map((_, i) => (
                    <FontAwesome
                      ...
                      name={
                        i < Math.floor(route.params?.rating || 0) ? "star" : "star-o"
                      }
                      size={15}
                      color="#FFD700"
                    />
                  ))}
                  <Text>{route.params?.rating || 0} (9 ratings)</Text>
                </View>
                <Pressable
                  style={{
                    marginTop: 6,
            ...
            <ScrollView showsHorizontalScrollIndicator={false} horizontal>
              {Array.isArray(route.params?.sportsAvailable) &&
